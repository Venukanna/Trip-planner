...
//                         <Link to="/bus-booking">Bus Booking</Link>
//                       </button>
...
import React, { useState, useEffect } from "react";
import Breadcrumbs from "../../components/Breadcrumbs/Breadcrumbs";
import { Col, Container, Form, Row, Card, ListGroup, Dropdown } from "react-bootstrap";
import DatePicker from "react-datepicker";
import { Link } from "react-router-dom";
import "../Booking/booking.css";
    ...
    <>
      ...
      <section className="booking-section py-5">
         ...
         <Dropdown className="d-inline-block ml-2">
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item as={Link} to="/bus-booking">
                            Bus Booking
                          </Dropdown.Item>
                          <Dropdown.Item as={Link} to="/flight-booking">
                            Flight Booking
                          </Dropdown.Item>
                          <Dropdown.Item as={Link} to="/train-booking">
                            Train Booking
                          </Dropdown.Item>
                          <Dropdown.Item as={Link} to="/hotel-booking">
                            Hotel Booking
                          </Dropdown.Item>
                        </Dropdown.Menu>
                      </Dropdown>
